// TODO(scaffold): replace this placeholder bank with the real classics for "Principle of Addition and Multiplication (2)".
(function (root) {
  "use strict";
  ...
  const CLASSICS = [
    {
      id: "addition-multiplication-2-placeholder",
  ...
  const SOURCE_COVERAGE = {
    "addition-multiplication-2-placeholder": ["TODO: list source sections that motivate this classic."]
  };
  ...
  const INTRO_SCENES = [
    {
      ...
      classicId: "addition-multiplication-2-placeholder",
      kind: "placeholder",
      durationMs: 9000,
  ...
  function placeholderProblem(variantIndex) {
    ...
    const classic = CLASSIC_BY_ID["addition-multiplication-2-placeholder"];
    const problem = {
      id: "addition-multiplication-2-placeholder-" + v,
      classicId: "addition-multiplication-2-placeholder",
  ...
  function generateProblem(classicId, variantIndex = 0) {
    if (classicId !== "addition-multiplication-2-placeholder") return null;
  ...
  function svgShell(inner) {
    return `<svg viewBox="0 0 560 330" role="img" aria-label="Principle of Addition and Multiplication (2) placeholder visual">${inner}</svg>`;
  }
  ...
  function createRound(offset = 0) {
    return Array.from({ length: ROUND_LENGTH }, (_, i) => generateProblem("addition-multiplication-2-placeholder", offset + i));
  }
