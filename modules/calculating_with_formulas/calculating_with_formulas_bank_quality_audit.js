...
const mod = require("./calculating_with_formulas_module.js");
...
function run() {
  ...
  console.log("Placeholder calculating_with_formulas bank audit passed for " + (mod.CLASSIC_IDS.length * 16) + " generated questions.");
}
