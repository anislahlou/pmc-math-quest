...
const mod = require("./prime_factorisation_2_module.js");
...
function run() {
  ...
  console.log("Placeholder prime_factorisation_2 bank audit passed for " + (mod.CLASSIC_IDS.length * 16) + " generated questions.");
}
